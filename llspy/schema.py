...
__defaults__ = {
    ...
    'NoBleachCorrection': (True,          'no photobleach correction'),
    'FlatStart'			: (False,		  'Use the median of image for start of decon'),
    'DoNotAdjustResForFFT':(False,		  'Do not adjust resolution for FFT during Decon'),
...
__validator__ = {
    ...
    'uint16'            : smartbool,
    'uint16raw'         : smartbool,
    'NoBleachCorrection': smartbool,
    'FlatStart'			: smartbool,
    'DoNotAdjustResForFFT':smartbool,
    'doReg'             : smartbool,
